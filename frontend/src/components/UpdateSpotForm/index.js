...
function UpdateSpotForm() {
    ...
    if (isLoaded) {
        ...
        if (spotImages && spotImages[0]) spot.imageOne = spotImages[0].url;
        if (spotImages && spotImages[1]) spot.imageTwo = spotImages[1].url;
        if (spotImages && spotImages[2]) spot.imageThree = spotImages[2].url;
        if (spotImages && spotImages[3]) spot.imageFour = spotImages[3].url;
